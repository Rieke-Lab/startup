...
function addConversionFactors(documentationService)
    ...
    message = appbox.MessagePresenter(['Do you want to add isomerization conversion factors to each epoch? ' ...
        'This process can take a minute or two and requires that you used the Device Configurator during your ' ...
        'experiment.'], ...
        ...
        'default', 2);
    message.goWaitStop();
    if ~strcmp(message.result, 'Add')
        return;
    end
    
    busy = appbox.BusyPresenter('Adding...', 'Adding isomerization conversion factors.', ...
